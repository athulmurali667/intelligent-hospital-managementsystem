...
(1,'contenttypes','0001_initial','2024-08-13 10:08:40.793121'),
(2,'auth','0001_initial','2024-08-13 10:08:41.671878'),
(3,'admin','0001_initial','2024-08-13 10:08:41.793824'),
(4,'admin','0002_logentry_remove_auto_add','2024-08-13 10:08:41.798339'),
(5,'admin','0003_logentry_add_action_flag_choices','2024-08-13 10:08:41.808871'),
(6,'contenttypes','0002_remove_content_type_name','2024-08-13 10:08:41.877338'),
(7,'auth','0002_alter_permission_name_max_length','2024-08-13 10:08:41.941093'),
(8,'auth','0003_alter_user_email_max_length','2024-08-13 10:08:41.956114'),
(9,'auth','0004_alter_user_username_opts','2024-08-13 10:08:41.971752'),
(10,'auth','0005_alter_user_last_login_null','2024-08-13 10:08:42.019202'),
(11,'auth','0006_require_contenttypes_0002','2024-08-13 10:08:42.019202'),
(12,'auth','0007_alter_validators_add_error_messages','2024-08-13 10:08:42.034838'),
(13,'auth','0008_alter_user_username_max_length','2024-08-13 10:08:42.114958'),
(14,'auth','0009_alter_user_last_name_max_length','2024-08-13 10:08:42.177548'),
(15,'auth','0010_alter_group_name_max_length','2024-08-13 10:08:42.193773'),
(16,'auth','0011_update_proxy_permissions','2024-08-13 10:08:42.209282'),
(17,'auth','0012_alter_user_first_name_max_length','2024-08-13 10:08:42.260065'),
(18,'myapp','0001_initial','2024-08-13 10:08:43.055872'),
(19,'sessions','0001_initial','2024-08-13 10:08:43.103157'),
(20,'myapp','0002_rename_qulifiction_doctor_table_qualifiction','2024-08-15 05:21:38.891507'),
(21,'myapp','0003_alter_doctor_table_age','2024-08-16 06:48:55.967429'),
(22,'myapp','0004_alter_doctor_table_age','2024-08-18 05:22:26.198255');
...
('13hd89mlzheg1j3irivo4cw616aimldm','eyJsaWQiOjIxfQ:1sfdtp:LC9mxGGFZ-P2LV3435-lzmoDHETgwiPpMjhqR1FPjts','2024-09-01 11:16:41.246970'),
('xw1uj88vqm8qy4hqlym6ys4a7mnxoecu','eyJsaWQiOjIxLCJjaWQiOjEsImRpZCI6IjciLCJib29raWQiOjJ9:1sfcmT:jNGgli2R9FJxmP9oPfLDtuxidv1DMICo7GSr_Y5VE8o','2024-09-01 10:05:01.859006');
...
insert  into `myapp_booking_table`(`id`,`date`,`status`,`SCHEDULE_id`,`USER_id`) values 
(2,'2024-08-18','accept',19,1);
...
insert  into `myapp_complaint_table`(`id`,`complaint`,`date`,`reply`,`USER_id`) values 
(1,'sample','2024-08-15','solvedd.',1);
...
(7,'ibrahim',20040313,'M','MD','Heart specialist',9876543210,'ibrahim@gmail.com','Screenshot_2023-09-10_114048.png',1,5,11),
(8,'    ALEN CHRISTO',65,'     M','     MA,MBBS','     EYE',9898989898,'     ALEN@GMAIL.COM','Screenshot 2023-09-10 113110_LpWUnqz.png',6,5,21);
...
(4,'Athul Memorial Hospital','sulthan bathery','sulthan bathery',1234567890,'athul@gmail.com',11.6629,76.257,8),
(5,'Nikson Memorial Hospital','sulthan bathery','sulthan bathery',3412567897,'nison@gmail.com',11.6629,76.257,9);
...
(4,'','','pending'),
(5,'','','pending'),
(6,'admin','admin1','pending'),
(7,'ibrahim','ib@2000','pending'),
(8,'athul','athul@2004','pending'),
(9,'nikson','Nikson1234','hospital'),
(10,'ggg','gggg','user'),
(11,'doc','doc','doctor'),
(12,'nikson','nikson','doctor'),
(13,'nikson','nikson','doctor'),
(14,'nikson','nikson','doctor'),
(15,'nikson','nikson','doctor'),
(16,'nikson','nikson','doctor'),
(20,'admin','admin','doctor'),
(21,'ALEN','alen2004','doctor'),
(22,'ibrahim','123','doctor'),
(23,'ibrahim','ibrahim123','doctor');
...
insert  into `myapp_rating_table`(`id`,`rating`,`review`,`date`,`DOCTOR_id`,`USER_id`) values 
(1,2.5,'hhhh','2024-08-18',7,1),
(2,4.5,'lll','2024-08-18',8,1);
...
insert  into `myapp_schedule_table`(`id`,`fromtime`,`totime`,`date`,`DOCTOR_id`) values 
(15,'10:00:00.000000','15:00:00.000000','2024-09-17',7),
(16,'10:00:00.000000','15:00:00.000000','2024-09-20',7),
(17,'10:00:00.000000','15:00:00.000000','2024-09-23',7),
(19,'10:00:00.000000','15:00:00.000000','2024-09-27',8);
...
(1,'ggg','Male',23,'kjnkj','kjnjk',876543,'ddd@hh.hh','hhh.png',10);
